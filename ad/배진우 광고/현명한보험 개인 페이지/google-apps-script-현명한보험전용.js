...
function sendTelegram(text) {
  const TELEGRAM_TOKEN = PropertiesService.getScriptProperties().getProperty('TELEGRAM_BOT_TOKEN');
  if (!TELEGRAM_TOKEN) throw new Error('스크립트 속성에 TELEGRAM_BOT_TOKEN을 입력하세요.');
